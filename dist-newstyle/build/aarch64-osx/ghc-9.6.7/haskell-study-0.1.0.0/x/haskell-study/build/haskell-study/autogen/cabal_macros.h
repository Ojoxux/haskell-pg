...
/* package haskell-study-0.1.0.0 */
#ifndef VERSION_haskell_study
#define VERSION_haskell_study "0.1.0.0"
#endif /* VERSION_haskell_study */
#ifndef MIN_VERSION_haskell_study
#define MIN_VERSION_haskell_study(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_study */
...
#define CURRENT_COMPONENT_ID "haskell-study-0.1.0.0-inplace-haskell-study"
